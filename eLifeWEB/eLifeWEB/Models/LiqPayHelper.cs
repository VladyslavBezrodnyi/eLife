    ...
    public class LiqPayHelper
    {
        ...
        static public LiqPayP2PFormModel GetLiqPayModel(Payment payment, TypeOfService typeOfService, ApplicationUser Patient)
        {
            ...
            var signature_source = new LiqPayP2P()
            {
                ...
                //receiver_card = new ApplicationDbContext().Users.FirstOrDefault(u => u.Id == payment.Record.TypeOfService.Doctor.Id).DoctorInform.Clinic.BankCard,
                currency = "UAH",
                ...
                sandbox = 1,
                language = "uk",
                result_url = "http://www.elife.com/DoctorInforms/AppointmentResult"
            };
